...
{
public:
    int skipCount, ansCount, correctAns;
...
void MathQuizGame::startGame()
{
    ...
    char ch;
lvl:
    cout << "---------------------- Welcome To Math Quiz Game OOP----------------------" << endl;
...
void MathQuizGame::easyMath()
{
    skipCount = 0, ansCount = 0, correctAns = 0;
    int ans[5], answer[5] = {1600, 779, 67, 120, 121};
    string ques[5] = {
...
void MathQuizGame::mediumMath()
{
    skipCount = 0, ansCount = 0, correctAns = 0;
    int ans[5], answer[5] = {10, 2, 20, -989, 750};
    string ques[5] = {
